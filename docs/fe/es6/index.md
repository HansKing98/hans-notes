...
```js
const [a, b, c] = 'hansking'
console.log(a) // m
console.log(b) // a
console.log(c) // o

/* 解构 length 属性 */
const { length } = 'hansking'
...
log('hansking', 1, 2) // hansking [1, 2]
log('hansking', 1, 2, 3) // hansking [1, 2, 3]
```
...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'hansking') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
```js
const obj = { name: 'hansking', age: 18 }
Object.keys(obj) // ['name', 'age']
Object.values(obj) //  ['hansking', 18]
Object.entries(obj) // [['name', 'hansking'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'hansking']]) // {name: 'hansking'}

/* Map 转对象 */
const map = new Map([['name', 'hansking']])
Object.fromEntries(map) // {name: 'hansking'}

/* 将查询字符串转为对象 */
const params = 'name=hansking&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'hansking', age: '18'}
```
...
[Promise 实现](https://github.com/hansking98/Promise) 简易实现、A+ 规范实现、原型方法、静态方法实现
