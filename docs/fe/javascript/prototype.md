...
// 对象实例
const person1 = new Person('hansking')
console.log(person1) // Person {name: 'hansking'}
```
...
Person.prototype.name = 'hansking'
...
console.log(person1.name, person2.name) // 'hansking' 'hansking'
```
...
// 对象实例
const person = new Person('hansking')
